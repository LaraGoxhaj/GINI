...
connection_rule[Subnet.device_type]=(UML.device_type, Switch.device_type, Router.device_type, Bridge.device_type, Hub.device_type, Firewall.device_type, REALM.device_type, yRouter.device_type)
...
connection_rule[yRouter.device_type]=(Subnet.device_type, yRouter.device_type)
